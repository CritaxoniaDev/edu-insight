...
import { FaCode, FaHourglassHalf, FaRocket } from 'react-icons/fa';
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center pointer-events-none">
                <div className="bg-white p-6 rounded-lg shadow-xl pointer-events-auto">
                    ...
                    <p className="flex items-center">
                        <FaHourglassHalf className="h-5 w-5 text-yellow-500 mr-2" />
                        <span>This page is currently under development and will be finished soon!</span>
                    </p>
                </div>
            </div>
            <div id="home" ref={ref} className="relative h-screen overflow-hidden filter blur-sm">
                <motion.div
                ...
                >
                    ...
                    <motion.div className="relative">
                        ...
                        >
                            ...
                            >
                                Where we can showcase the skills and connect with
                            </motion.span>{" "}
                            <motion.span
